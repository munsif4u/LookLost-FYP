...
//CHAT FRAGMENT PAGE WHich is accessed by Main Menu
...
public class chatFragment extends Fragment {
    ...
    public static chatFragment newInstance(int fragmentId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // ####### CHAT #####
        final RecyclerView messagesRecyclerView = view.findViewById(R.id.messagesRecyclerView);

        // get user's mobile number from memory
        final String mobileNumber = MemoryData.getMobile(getContext());
        ...
        messagesAdapter = new MessagesAdapter(userMessagesList, getContext());
                    ...
                    if (getMobile != null) {
                        ...
                        if (!getMobile.equals(mobileNumber)) {
                            ...
                            if (!chatKey[0].isEmpty()) {
                                ...
                                final long userLastSeenMessage = Long.parseLong(MemoryData.getLastMsgTS(getContext(), chatKey[0]));
